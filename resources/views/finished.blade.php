    ...
    <div class="w-9/12 mx-auto p-3 m-3">
        ...
        <div class="mx-auto border">
            <div class="px-4 py-3 border-b bg-gradient-to-r from-cyan-500 to-indigo-500 rounded-t-lg">
                <p class="text-2xl font-semibold text-white">Finished Task - ToDo</p>
            </div>
                ...
                @foreach ($tasks as $task)
                    <div class="flex flex-col bg-white rounded-md p-2 px-4 border hover:shadow-2xl">
                        ...
                        <div class="mt-auto py-1">
                            <p>{!! $task->completed_on ? '<span class="text-sm">Finished On: </span><strong>'. $task->completed_on .'</strong>' : '' !!}</p>
                        </div>
                        <div class="mt-2">
            ...
            @else
                <div class="text-center mx-auto py-3">
                    <p class="text-4xl font-bold text-gray-600 mt-10 mb-10">No Finished Task</p>
                </div>
            @endif
        </div>
    </div>
